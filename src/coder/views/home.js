...
export function homeView() {
    ...
    <div class="text-center py-10 sm:py-14 bg-[#f6fcf9]">
        ...
        <div class="flex justify-center mb-8">
            <div class="bg-blue-50 border border-blue-200 rounded-lg px-3 py-1 flex items-center gap-2">
                <svg class="w-3 h-3" viewBox="0 0 10 10" fill="none">
                    <path
                        ...
                        stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.875" />
                </svg>
                <span class="text-blue-600 text-xs font-medium">Powered by Innovation</span>
            </div>
        </div>
        <div class="text-center mb-8 px-2">
            <h1 class="text-3xl sm:text-5xl font-bold text-gray-800 mb-6 leading-tight">
                Connecting
        ...
        <!-- Two Cards -->
        <div class="flex flex-col md:flex-row md:gap-4 gap-8 justify-center items-center">
            <!-- For Companies Card -->
            <div
                ...
                <div class="bg-blue-50 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8" viewBox="0 0 32 32" fill="none">
                        <path
                            ...
                            stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.66667" />
                        <path
                        ...
                        <path
                            ...
                            stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.66667" />
                        <path d="M13.3333 8H18.6667" stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2.66667" />
                        <path d="M13.3333 13.3333H18.6667" stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2.66667" />
                        <path d="M13.3333 18.6667H18.6667" stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2.66667" />
                        <path d="M13.3333 24H18.6667" stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2.66667" />
                    </svg>
                </div>
                    ...
                    <svg class="block w-full h-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
                        <g>
                            <path
                                ...
                                fill="url(#paint0_linear_1_771)" opacity="0.1" />
                            <path
                            ...
                            <path d="M16 15H24" stroke="url(#paint3_linear_1_771)" stroke-linecap="round"
                                stroke-width="2" />
                            <path d="M16 22L20 26L24 22" stroke="url(#paint4_linear_1_771)" stroke-linecap="round"
                            ...
                            <path
                                ...
                                fill="url(#paint5_linear_1_771)" opacity="0.6" />
                            <path
                                ...
                                fill="url(#paint6_linear_1_771)" opacity="0.6" />
                            <path
                                ...
                                fill="url(#paint7_linear_1_771)" opacity="0.6" />
                            <path
                                ...
                                fill="url(#paint8_linear_1_771)" opacity="0.6" />
                        </g>
                        <defs>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_771" x1="2" x2="3602" y1="2"
                                y2="3602">
                                <stop stop-color="#1C75BC" />
                                <stop offset="1" stop-color="#3B8FD6" />
                            </linearGradient>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_771" x1="8" x2="808" y1="11"
                                y2="811">
                                <stop stop-color="#1C75BC" />
                                <stop offset="1" stop-color="#3B8FD6" />
                            </linearGradient>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_771" x1="24" x2="824" y1="11"
                                y2="811">
                                <stop stop-color="#78BE20" />
                                <stop offset="1" stop-color="#89D426" />
                            </linearGradient>

                            <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_1_771" x1="16" x2="336" y1="22"
                                y2="662">
                                <stop stop-color="#78BE20" />
                                <stop offset="1" stop-color="#89D426" />
                            </linearGradient>

                            <linearGradient gradientUnits="userSpaceOnUse" id="paint5_linear_1_771" x1="6.5" x2="306.5"
                                y1="26.5" y2="326.5">
                                <stop stop-color="#1C75BC" />
                                <stop offset="1" stop-color="#3B8FD6" />
                            </linearGradient>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint6_linear_1_771" x1="12.5" x2="312.5"
                                y1="30.5" y2="330.5">
                                <stop stop-color="#78BE20" />
                                <stop offset="1" stop-color="#89D426" />
                            </linearGradient>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint7_linear_1_771" x1="24.5" x2="324.5"
                                y1="30.5" y2="330.5">
                                <stop stop-color="#1C75BC" />
                                <stop offset="1" stop-color="#3B8FD6" />
                            </linearGradient>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint8_linear_1_771" x1="30.5" x2="330.5"
                                y1="26.5" y2="326.5">
                                <stop stop-color="#78BE20" />
                                <stop offset="1" stop-color="#89D426" />
                            </linearGradient>
            ...
            <!-- For Coders Card -->
            <div class="backdrop-blur-sm bg-white bg-opacity-80 rounded-xl p-6 shadow-lg max-w-sm w-full md:w-auto">
                <div class="bg-green-50 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8" viewBox="0 0 32 32" fill="none">
                        <path d="M21.3333 24L29.3333 16L21.3333 8" stroke="#78BE20" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="2.66667" />
                        <path d="M10.6667 8L2.66667 16L10.6667 24" stroke="#78BE20" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="2.66667" />
                    </svg>
                </div>
                <h3 class="font-semibold text-gray-800 text-center mb-2">
    ...
    <section class="bg-slate-50 py-10 sm:py-16 px-2 sm:px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div
                ...
                <!-- Step 1 -->
                <div class="bg-white rounded-xl p-8 shadow-lg text-center relative mx-auto">
                    <div class="bg-slate-100 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-8">
                        <svg class="w-8 h-8" viewBox="0 0 32 32" fill="none">
                            <path d="M28 28L22.2133 22.2133" stroke="#1C75BC" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2.66667" />
                            <path
                    ...
                    <div class="bg-blue-600 w-7 h-7 rounded-full flex items-center justify-center mx-auto mb-6">
                    ...
                    <div class="bg-slate-100 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-8">
                        <svg class="w-8 h-8" viewBox="0 0 32 32" fill="none">
                            <path
                                ...
                                stroke="#78BE20" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.66667" />
                            <path d="M12 24H20" stroke="#78BE20" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2.66667" />
                            <path d="M13.3333 29.3333H18.6667" stroke="#78BE20" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2.66667" />
                        </svg>
                    </div>
                    <div class="bg-blue-600 w-7 h-7 rounded-full flex items-center justify-center mx-auto mb-6">
    ...
    <section class="bg-[#f4f8fd] py-14 sm:py-20 border-b border-[#e0e7ef]">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-3xl sm:text-4xl font-extrabold text-[#1e5bb6] mb-3 leading-tight">
                    Partner Companies
                </h2>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 sm:gap-8 justify-items-center items-center">
                <div
                    ...
                    <img src="/smart-fit-logo.png" alt="smart-fit-logo" class="w-16 h-16 object-contain mb-2" />
                </div>
                <div
                    class="bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center transition-transform hover:scale-105 hover:shadow-xl duration-200">
                    <img src="/postobon-logo.png" alt="postobon-logo" class="w-16 h-16 object-contain mb-2" />
                </div>
                <div
                    class="bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center transition-transform hover:scale-105 hover:shadow-xl duration-200">
                    <img src="/nequi-logo.png" alt="nequi-logo" class="w-16 h-16 object-contain mb-2" />
                </div>
                <div
                    class="bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center transition-transform hover:scale-105 hover:shadow-xl duration-200">
                    <img src="/BlackBird-logo.jpg" alt="BlackBird-logo" class="w-16 h-16 object-contain mb-2" />
                </div>
                <div
                    class="bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center transition-transform hover:scale-105 hover:shadow-xl duration-200">
                    <img src="/auteco-logo.png" alt="auteco-logo" class="w-16 h-16 object-contain mb-2" />
                </div>
                <div
                    class="bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center transition-transform hover:scale-105 hover:shadow-xl duration-200">
                    <img src="/sistecredito-logo.png" alt="sistecredito-logo" class="w-16 h-16 object-contain mb-2" />
                </div>
            </div>
        </div>
    </section>
